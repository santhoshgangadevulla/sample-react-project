    ...
    return(
        <div className="sh-hero-container">
            <div className="sh-hero-wrapper d-flex align-items-center justify-content-center justify-content-xl-between">
                <img className="d-none d-xl-block" src="./assets/header-start-image.png" alt="header-start-img" />
                ...
                <img className="d-none d-xl-block" src="./assets/header-end-image.png" alt="header-start-img" />
            </div>
        </div>
    )
}
